...
const AboutPage = () => {
  ...
  return (
    <div className="h-full">
      {/* FIRST CONTAINER */}
      <div className="flex flex-col md:flex-row items-center pt-10 md:pt-0 lg:pt-10 lg:pb-5 pl-5 pr-5">
        {/* IMAGE */}
        ...
        {/* TEXT */}
        <div className="h-full w-full md:w-1/2 flex flex-col text-center text-white pl-2 pr-2 pb-5">
          {/* TEXT CONTAINER */}
      ...
      <div className="flex items-center justify-center">
        <div className="h-[20rem] sm:h-[23rem] lg:h-[30rem] xl:h-[35rem] w-[30rem] sm:w-[35rem] md:w-[70rem] flex lg:pt-10 pb-10 pl-5 pr-5">
