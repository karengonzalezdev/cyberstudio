 ...
 <div className="h-full">
    ...
    <div className="h-full flex flex-wrap items-center justify-center pl-5 pt-5 pr-5 pb-5 gap-10">
        ...
        <div className="h-[20rem] w-[23rem] text-white rounded-xl text-center pt-5 pl-5 pr-5 pb-5 bg-violet-950 hover:bg-violet-900">
            <h1 className="text-3xl font-bold">Sesión casual</h1>
            <p className="text-lg">24 fotos sesion de 2 horas, 1,200$</p>
        </div>
        {/* CARD 2 */}
        <div className="h-[20rem] w-[23rem] text-white rounded-xl text-center pt-5 pl-5 pr-5 pb-5 bg-violet-950 hover:bg-violet-900">
            <h1 className="text-3xl font-bold">Evento paquete 1</h1>
        ...
        {/* CARD 3 */}
        <div className="h-[20rem] w-[23rem] text-white rounded-xl text-center pt-5 pl-5 pr-5 pb-5 bg-violet-950 hover:bg-violet-900">
            <h1 className="text-3xl font-bold">Evento paquete 2</h1>
        ...
        {/* CARD 4 */}
        <div className="h-[20rem] w-[23rem] text-white rounded-xl text-center pt-5 pl-5 pr-5 pb-5 bg-violet-950 hover:bg-violet-900">
            <h1 className="text-3xl font-bold">Fotomontaje</h1>
