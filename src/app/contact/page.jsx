...
const sendEmail = (e) => {
 ...
 return (
  ...
  <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 pb-5 pt-5 items-center justify-center">
      ...
      <form
          onSubmit={sendEmail} 
          ref={form} className="h-[80%] lg:h-full md:w-1/2 lg:w-1/2 bg-purple-50 rounded-xl text-lg lg:text-xl xl:text-xl flex flex-col gap-8 justify-center px-10 sm:px-12 md:px-15 pt-10 md:pt-15 lg:px-20 lg:pt-10 pb-20 md:pb-34">
