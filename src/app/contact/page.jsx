  ...
  return (
    <motion.div className="h-full" initial={{ y: "-200vh" }} animate={{ y: "0%" }} transition={{ duration: 1 }}>
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 pb-5 pt-5 items-center justify-center">
        {/* TEXT CONTAINER */}
        <div className="h-1/2 lg:h-full lg:w-1/2 flex items-center justify-center text-white text-3xl lg:text-6xl pt-3 lg:pt-0 pb-3 lg:pb-0">
        ...
        <form
          onSubmit={sendEmail}
          ref={form} className="h-[80%] lg:h-full md:w-1/2 lg:w-1/2 flex flex-col justify-center bg-purple-50 text-black text-lg lg:text-xl gap-8 pt-10 md:pt-15 lg:pt-10 px-10 sm:px-12 md:px-15 lg:px-20 pb-20 md:pb-34">
          ...
          <span>Saludos!</span>
          <button className="bg-purple-200 font-semibold text-gray-600 lg:p-4">Enviar</button>
