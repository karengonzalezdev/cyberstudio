  ...
  return (
    ...
    <div className="h-1/3 lg:h-full lg:w-1/2 relative">
      ...
      <div className="h-[25rem] flex">
            <div className="bg-yellow-50 h-[80%] w-[80%] m-auto"></div>
          </div>
          {/* SECTIONS */}
      <div className="flex w-full h-[40rem]">
            <div className="bg-blue-200 w-1/3 flex">
              {/* CONTAINER 1 */}
            ...
            <div className="bg-blue-300 w-1/3 flex">
              {/* CONTAINER 2*/}
              <div className="h-[80%] w-[80%] bg-yellow-50 m-auto rounded-xl">
                {/* TEXT */}
                <div className="h-1/3 bg-red-500"></div>
            ...
            <div className="bg-blue-900 w-1/3 flex">
              {/* CONTAINER 3 */}
              <div className="h-[80%] w-[80%] bg-yellow-50 m-auto rounded-xl">
                {/* TEXT */}
                <div className="h-1/3 bg-red-500"></div>
