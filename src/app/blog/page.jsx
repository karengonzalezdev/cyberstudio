...
const BlogPage = () => {
    ...
    return (
        <div className="h-full flex flex-col items-center">
            ...
            {/* SECTIONS */}
            <div className="h-full flex flex-col items-center justify-center gap-10 pt-[12%] sm:pt-7 pl-7 pr-7 pb-[15%] sm:pb-10 lg:pb-[5%]">
                <div className="h-[8rem] sm:h-[10rem] lg:h-[15rem] w-[22rem] sm:w-[38rem] lg:w-[55rem] xl:w-[63rem] flex bg-violet-950 hover:bg-violet-900">
                    {/* IMAGE */}
