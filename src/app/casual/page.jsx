...
<div className="bg-gradient-to-b from-yellow-500 to-yellow-400">
    ...
    <div className="h-[7rem]">
        <h1 className="text-5xl text-center pt-7 font-bold text-glitch text-glitch-duration-slow">Casual</h1>
    </div>
    {/* SERVICES CONTAINER */}
    <div className="h-full flex flex-wrap items-center justify-center pl-5 pt-5 pr-5 pb-[7%] gap-10">
        ...
        <Image src="https://raw.githubusercontent.com/karenfggutierrez/Images/main/cyberstudio/casual2.jpg" alt="Background" className="object-contain w-auto h-full mx-auto" width={300} height={300} responsive="true"/>
        </div>
    </div>
    <ScrollButton />
 </div>
